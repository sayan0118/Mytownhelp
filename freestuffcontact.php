...
error_reporting( E_ERROR );
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $to= $_POST['recipnt'];
        $subject = "Response to your free stuff post";
...
<form method="POST" action="freestuffcontact.php">

    <div class="input-group">
        <label>To</label>
        <input type="text" name="recipnt" id="recipnt" value="<?php echo $to; ?>" required readonly>
    </div>
